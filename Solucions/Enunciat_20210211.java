...
public class Enunciat_20210211 {
  ...
  public static boolean comprovaEsEnter(char caracterRebut) {
   ...
   do {   /// REPETIR per acabar  (volsAcabar == false);
      ...
      mostrarMissatgePerPantallaSegonsSaltLinea(
         "Si vols en Majúscules (M),\n" + 
      ...
      do {   /// REPETIR per perOmplirMatriu
         ...
         if (   (perOmplirMatriu == 'M')
            || (perOmplirMatriu == 'm')
            || (perOmplirMatriu == 'e') ) {
            pucAcabar = true;
            matriu = ompleMatriu(files, columnes, perOmplirMatriu);
         } else { // ( !( (perOmplirMatriu == 'M') || (perOmplirMatriu == 'm') || (perOmplirMatriu == 'e') ) )
            mostrarMissatgePerPantallaSegonsSaltLinea("Si us plau, entra només un dels valors següents\n"
      ...
      if (   (perAcabar == 's')
          || (perAcabar == 'S')  ){
         volsAcabar = true;
         mostrarMissatgePerPantallaSegonsSaltLinea("Fins la propera!", true);
      }
