...
public class LlegirCsvISumarSenseFuncions {
  ...
  public static void main(String[] args) {
    ...
    String nomFitxerLlegir = "fitxerLlegir.txt";

    // Creem una variable amb el nom del fitxer que volem escriure
    String nomFitxerEscriure = "nombresSumats.txt";
    ...
    try { // Per controlar el fitxer que volem llegir
      ...
      File fitxerLlegir = new File("lib/" + nomFitxerLlegir);
      ...
      try { // Per controlar el fitxer que volem escriure
        FileWriter fitxerEscriure = new FileWriter("lib/" + nomFitxerEscriure);
